...
2. **Conteúdo**: Atualize o texto em `index.html`
3. **Imagens**: Adicione imagens na pasta `assets/images/` e atualize as referências
4. **Links**: Atualize os links das plataformas na seção correspondente
...
Este projeto é de uso livre para fins educacionais e de divulgação.

---

**Desenvolvido para** divulgação da obra de Erigutemberg Meneses  
